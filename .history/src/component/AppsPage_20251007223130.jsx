    ...
    return (
        ...
        <div className='my-[70px] max-w-[1440px] mx-auto' >
            ...
            <div className='grid grid-cols-4 gap-[40px]' >
                {
                    dataFilter.length > 0 ? dataFilter.map(data => <AppsCard key={data.id} data={data} ></AppsCard> ) : <h1 className='text-center text-[48px] font-bold text-gra' >No Apps Found</h1>
                }
            </div>
        </div>
