    ...
    return (
        <div>
            <section className="bg-gray-50 text-center pt-16">
                ...
                <div className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        <div>
                            <p>Total Downloads</p>
                            <p className="text-4xl font-bold my-[10px]">29.6M</p>     
                            <p className="text-sm opacity-80">21% More Than Last Month</p>
                        </div>
                        <div>
                             <p>Total Reviews</p>
                            <p className="text-4xl font-bold my-[10px]">906K</p>                        
                            <p className="text-sm opacity-80">46% More Than Last Month</p>
                        </div>
                        <div>
                            <p>Active Apps</p>
                            <p className="text-4xl font-bold my-[10px]">132+</p>                         
            ...
            <section className="my-[70px] w-full max-w-[1440px] mx-auto px-6">
                ...
                <div className="grid justify-center items-center gap- sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    {datas.map((data) => (
