    ...
    return (
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-[100px] bg-white p-8 rounded-2xl ">
        ...
        <div className="flex-1">
          ...
          <button onClick={buttonHandler} className="bg-emerald-500 hover:bg-emerald-600 transition text-white font-semibold px-6 py-3 rounded-lg text-lg shadow"> { i } </button>
        </div>
      </div>
    </div>
    );
