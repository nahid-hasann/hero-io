    ...
    if (!app || isinvalidId) {
        return (
            <div className="flex flex-col justify-center items-center h-screen text-center">
                <h1 className="text-4xl font-bold text-red-500 mb-4">App Is Not Found</h1>
                <p className="text-gray-500 text-lg mb-6">
                    The app you are looking for does not exist or has been romoved
                </p>
                <Link to="/" className="bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition">back to home
                </Link>
            </div>
        );
    }
