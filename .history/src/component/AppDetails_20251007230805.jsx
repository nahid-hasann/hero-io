...
const AppDetails = () => {
    ...
    return (
       ...
       <div className="max-w-6xl mx-auto bg-gray-100 min-h-screen py-16 px-6">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-10 bg-white p-8 rounded-2xl shadow">
