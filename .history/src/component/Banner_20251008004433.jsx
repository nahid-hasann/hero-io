        ...
        <div>
            <section className="bg-gray-50 text-center pt-16">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    ...
                    <a href="https://www.apple.com/app-store/" target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-gray-100hover:bg-gray-200 text-gray-800 px-5 py-2 rounded-lg shadow-sm transition"
                    >
                        <FaApple /> App Store
                    </a>
                </div>
