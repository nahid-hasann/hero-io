            ...
            <Link to="/">
                <div className="flex items-center space-x-2">
                    <img
                        ...
                        className="w-8 h-8"
                    />
                    <h1 className="text-lg font-bold text-[]">HERO.IO</h1>
                </div>
            </Link>


            <nav className="hidden md:flex items-center space-x-6">
                <Link className="text-gray-700 hover:text-indigo-500" to="/">
                  Home
                </Link>
                <Link className="text-gray-700 hover:text-indigo-500" to="/apps">
                  Apps
                </Link>
