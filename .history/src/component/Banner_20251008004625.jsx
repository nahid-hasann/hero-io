    ...
    return (
        <div>
            <section className="bg-gray-50 text-center pt-16">
                ...
                <p className="max-w-2xl mx-auto text-gray-500 mb-8"> At <span className="font-semibold text-indigo-600">HERO.IO</span>, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.
