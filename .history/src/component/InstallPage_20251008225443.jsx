...
const InstallPage = () => {
    ...
    return (
      ...
      <p className="text-center text-gray-500 mb-10"> Explore All Trending Apps on the Market developed by us
      </p>

      {installApps.length === 0 ? (
        <p className="text-center text-xl text-gray-500">No apps</p>
      ) : (
        <div>
