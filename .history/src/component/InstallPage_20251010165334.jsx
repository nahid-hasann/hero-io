...
const InstallPage = () => {
  ...
  if (type === "low to high") {
    sorted = [...installedApps].sort((a, b) => parseInt(a.downloads) - parseInt(b.downloads));
  } 
  else if (type === "high to low") {
    sorted = [...installedApps].sort((a, b) => parseInt(b.downloads) - parseInt(a.downloads));
  }
  ...
  setInstalledApps(sorted);
    ...
    return (
        <div className="max-w-[1440px] mx-auto py-10">
            ...
            <p className="text-center text-gray-500 mb-10"> Explor All Trending Apps on the Market developed by us</p>

            <ToastContainer />

            {installedApps.length === 0 ? (<p className="text-center text-xl text-gray-500">No apps</p>) : (
                <div>
                    <div className='flex justify-between my-[20px] px-[40px]'>
