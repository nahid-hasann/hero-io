...
const InstallPage = () => {
    ...
    const handlesort = (type) => {
      setsort(type);
      let sorted = [...installApps];
      if(type === "low to heigh"){
        const sortbyLH = [...installApps].sort((a, b) => a.size - b.size)
      }
      else if(){
                        ...
                        <div>
                            <div className="dropdown">
                                ...
                                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                                    <li><a onClick={() => handlesort("low to heigh")} >Low to High</a></li>
                                    <li><a onClick={() => handlesort("heigh to low")}>Heigh to Low</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
