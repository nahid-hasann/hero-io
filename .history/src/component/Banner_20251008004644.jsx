    ...
    return (
        <div>
            <section className="bg-gray-50 text-center pt-16">
                ...
                <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4"> We Build <span className="text-purple-600">Productive</span> Apps</h1>


                <p className="max-w-2xl mx-auto text-gray-500 mb-8"> At <span className="font-semibold text-indigo-600">HERO.IO</span>, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.  Our goal is to turn your ideas into digital experiences that truly make an impact. </p>
